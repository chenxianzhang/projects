<template>
  <div>
    ...
    <div class="btn-group">
      <el-button @click="makeGroup('随机分组')">随机分组</el-button>
      <el-button @click="makeGroup('自由分组')">学生自由分组</el-button>
      <el-button @click="makeGroup('指定分组')">指定分组</el-button>
      <el-button @click="makeGroup('添加到分组')">添加到已有分组</el-button>
    </div>
